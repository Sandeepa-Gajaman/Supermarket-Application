...
<tr>
  <td colspan="5" align="right"><a href="#" class="btn btn-sm btn-primary" id= "proceedButton" onclick= "invokeProceedForm();" style= "margin: 5px;"><span class="glyphicon glyphicon-chevron-right"></span> Proceed</a></td>
</tr>
</tbody>
</table>
...
<!-- Modal box for the proceed button-->

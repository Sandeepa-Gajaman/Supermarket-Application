...
INSERT INTO `item` (`item_code`, `item_category`, `item_brand`, `image`, `item_name`, `item_description`, `item_volume`, `item_quantity`, `item_unit_price`) VALUES
(1, 'Soap', 'Sunlight', 'product-images/sunSoap.jpg', 'Sunlight yellow 50g', 'Sunlight yellow laundry soap', '50g', 45, '35.00'),
(2, 'Soap', 'Pears', 'product-images/pearsblue.jpg', 'Pears baby blue', 'Pears baby blue with extra softness', '50g', 103, '45.00'),
(4, 'Exercise Book', 'Promate', 'product-images/proCR.jpg', 'A4 80 pages Single', 'Single ruled, 80 page CR exercise book.', '80 pages', 35, '110.00'),
(5, 'Pen', 'Atlas ', 'product-images/atlasPen.jpg', 'Atlas chooty blue ', 'Atlas chooty blue ball', '10g', 166, '15.00'),
(6, 'Biscuits', 'Munchee', 'product-images/Cracker.jpg', 'Cream Cracker', 'Munchee cream cracker small', '150g', 0, '75.50');
...
INSERT INTO `supplier_item` (`supplier_code`, `item_code`) VALUES
(1, 6),
(2, 2),
(2, 5);
...
ALTER TABLE `supplier_item`
  ADD PRIMARY KEY (`supplier_code`,`item_code`);
